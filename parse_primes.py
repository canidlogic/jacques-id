...
"""
Parse the list of the first 1000 prime numbers from the PrimePages.

The needed data file is available from:
...
integers read in from the file if successful, or throws an exception if
there was a problem.

Content lines in the data file contain nothing other than a sequence of
one or more decimal integers separated by whitespace, and with optional
leading and trailing whitespace.  All other kinds of lines are ignored.
...
All exceptions generated by this module are subclasses of PrimeError and
